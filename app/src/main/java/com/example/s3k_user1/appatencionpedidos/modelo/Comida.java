package com.example.s3k_user1.appatencionpedidos.modelo;
...
public class Comida {
    ...
    static {
        COMIDAS_POPULARES.add(new Comida(5, "Maquina", R.drawable.camarones));
        COMIDAS_POPULARES.add(new Comida(3.2f, "Maquina 2", R.drawable.rosca));
        COMIDAS_POPULARES.add(new Comida(12f, "Maquina 3", R.drawable.sushi));
        COMIDAS_POPULARES.add(new Comida(9, "Maquina Sl", R.drawable.sandwich));
        COMIDAS_POPULARES.add(new Comida(34f, "Maquina S3K", R.drawable.lomo_cerdo));
