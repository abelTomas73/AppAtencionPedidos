...
public class FragmentoCategoriasProductos extends Fragment {
    ...
    private void poblarCategoriasCombos() {
        ...
        COMIDAS_POPULARES.add(new Comida(5,5, "Bebidas Sin Alcohol", R.drawable.coctel));
        ...
        COMIDAS_POPULARES.add(new Comida(8,5, "Bebidas Con Alcohol", R.drawable.coctel_jordano));
        COMIDAS_POPULARES.add(new Comida(9,5, "Combos", R.drawable.camarones));
